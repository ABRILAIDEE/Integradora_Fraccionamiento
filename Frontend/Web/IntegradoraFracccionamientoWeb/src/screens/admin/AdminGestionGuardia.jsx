        ...
        <div style={styles.container} className="container">
            ...
            <div style={styles.tableContainer} className="table-container">
                <table style={styles.table} className="table">
                    <thead>
                        <tr>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Id guardias</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Nombre (s)</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Correo</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Fecha de nacimiento</th>
...
export default AdminGestionGuardia;