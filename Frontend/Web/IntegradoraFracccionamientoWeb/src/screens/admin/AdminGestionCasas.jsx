    ...
    return (
        <div style={styles.container} className="container">
            ...
            <div style={styles.titleContainer} className="title-container">
                <h1 style={styles.subtitle} className="subtitle">Casas</h1>
            ...
            <div style={styles.tableContainer} className="table-container">
                <table style={styles.table} className="table">
                    <thead>
                        <tr>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Id casa</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Descripcion (s)</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>Calle</th>
                            <th style={{...styles.tableCell, ...styles.tableHeader}}>numero de casa</th>
