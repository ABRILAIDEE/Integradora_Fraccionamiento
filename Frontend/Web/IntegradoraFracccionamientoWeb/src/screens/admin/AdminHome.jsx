  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.loginBox}>
        ...
        <button style={styles.createVisitButton}>Gestion de guardias</button>
        <button style={styles.myVisitsButton}>Gestion de residentes</button>
        <button style={styles.myVisitsButton}>Gestion de casas</button>
        <button style={styles.myVisitsButton}>Gestion de visitas</button>
      </div>
    </div>
  );
}
